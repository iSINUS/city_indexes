...
tables.polygons = osm2pgsql.define_area_table('polygons', {
    ...
    { column = 'building_part',     type = 'text' },
...
function osm2pgsql.process_node(object)
    ...
    tables.points:insert({
        tags = object.tags,
        public_transport = object:grab_tag('public_transport'),
...
function osm2pgsql.process_way(object)
    ...
    if object.is_closed and has_area_tags(object.tags) then
        ...
        tables.polygons:insert({
            ...
            building_part = object:grab_tag('building:part'),
            building_levels = tonumber(object:grab_tag('building:levels')),
            amenity = amenity,
...
function osm2pgsql.process_relation(object)
    ...
    -- Go through all the members and store member ids
